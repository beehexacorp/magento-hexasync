...
namespace Beehexa\HexaSync\Controller\Adminhtml\Log;

class Edit extends \Beehexa\HexaSync\Controller\Adminhtml\Log
{
    ...
    public function execute()
    {
        ...
        $model = $this->_objectManager->create(\Beehexa\HexaSync\Model\Log::class);
        ...
        $this->_coreRegistry->register('beehexa_hexasync_log', $model);
