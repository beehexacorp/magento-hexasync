...
class Save extends \Magento\Backend\App\Action
{
    ...
    public function execute()
    {
        ...
        if ($data) {
            ...
            $model = $this->_objectManager->create(\Beehexa\HexaSync\Model\Log::class)->load($id);
            if (!$model->getId() && $id) {
            ...
            try {
                ...
                $this->dataPersistor->clear('beehexa_hexasync_log');
            ...
            $this->dataPersistor->set('beehexa_hexasync_log', $data);
